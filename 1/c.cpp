...
#define SIZE_X 20
#define SIZE_Y 20
#define PRODUCT_LENGHT 4

int a [][SIZE_Y+PRODUCT_LENGHT*2] = {
...
int main(int argc, char const *argv[])
{
	...
	{
		for (int j = PRODUCT_LENGHT; j < SIZE_Y; ++j)
		{
			for (int d = 0; d < 4; ++d)
			{
				int current = 1;
				for (int k = 0; k < PRODUCT_LENGHT; ++k)
				{
					current *= a[i+dx[d]*k][j+dy[d]*k];
				}
				if (current > max)
				{
					// for (int k = 0; k < PRODUCT_LENGHT; ++k)
					// {
					// 	cout << a[i+dx[d]*k][j+dy[d]*k] << " ";
					// }
					// cout << "\n";
					max = current;
					max_i = i;
