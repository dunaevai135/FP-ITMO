...
-- apstractProduct :: Int -> Int -> Int -> Int -> Int
apstractProductInternal 0 _ _ _ _ acc = acc
apstractProductInternal n x y dx dy acc = apstractProductInternal (n-1) (x+dx) (y+dy) dx dy ((getaAt x y) * acc)

apstractProduct n x y dx dy = apstractProductInternal n x y dx dy 1
